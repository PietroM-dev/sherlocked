const secretPuzzles = [
  {
    ...
    difficulty: 4,
    icon: "💀",
    hiddenClue: "01001000 01000101 01001100 01010000 — deciframi e saprai il vero nome dell'operazione.",
  ...
  },
  {
    ...
    difficulty: 3,
    icon: "🎻",
    hiddenClue: "Il gioco è sempre in corso, Watson. Anche quando pensi che sia finito.",
  ...
  },
  {
    ...
    difficulty: 4,
    icon: "🧦",
    hiddenClue: "Il principio della piccionaia funziona ovunque. Anche con i sospettati: se hai 3 indizi e 2 possibili colpevoli...",
  ...
  },
  {
    ...
    difficulty: 3,
    icon: "👻",
    hiddenClue: "I fantasmi non esistono. Ma i segreti nascosti in piena vista sì. Ne hai trovati tutti e quattro?",
